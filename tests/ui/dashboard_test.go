...
func TestDashboard(t *testing.T) {
	...
	// Wait for initial data load (Alpine, SSR hydration, API fetches)
	_ = chromedp.Run(ctx, chromedp.Sleep(2*time.Second))

	// --- NoJSErrors first (before any interaction tests that might cause errors) ---
	...
	// --- Read-only / non-interactive tests ---
	...
	t.Run("HoldingsTable", func(t *testing.T) {
	...
	t.Run("PortfolioSummary", func(t *testing.T) {
	...
	t.Run("ColumnAlignment", func(t *testing.T) {
	...
	t.Run("GainColors", func(t *testing.T) {
	...
	t.Run("DefaultCheckbox", func(t *testing.T) {
	...
	t.Run("NoTemplateMarkers", func(t *testing.T) {
	...
	t.Run("CapitalPerformance", func(t *testing.T) {
	...
	t.Run("GrowthChart", func(t *testing.T) {
	...
	t.Run("ChangesRow", func(t *testing.T) {
	...
	t.Run("ReturnDollarChanges", func(t *testing.T) {
	...
	t.Run("ReturnPctChanges", func(t *testing.T) {
	...
	t.Run("GlossaryTooltips", func(t *testing.T) {
	...
	t.Run("BreadthBar", func(t *testing.T) {
	...
	t.Run("HoldingTrendArrows", func(t *testing.T) {
	...
	t.Run("LastSynced", func(t *testing.T) {
	...
	t.Run("SSR_DataPreRendered", func(t *testing.T) {
	...
	t.Run("EquityInPerformanceRow", func(t *testing.T) {
	...
	t.Run("TickerLinks", func(t *testing.T) {
	...
	t.Run("HoldingDetailFields", func(t *testing.T) {
	...
	t.Run("RefreshButton", func(t *testing.T) {
	...
	t.Run("PortfolioDropdown", func(t *testing.T) {
