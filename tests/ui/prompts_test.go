...
func TestPromptsPageLayout(t *testing.T) {
...
func TestPromptsPageNavVisible(t *testing.T) {
	ctx, cancel := newBrowser(t)
	defer cancel()
...
func TestPromptsPagePanelHeader(t *testing.T) {
	ctx, cancel := newBrowser(t)
	defer cancel()
...
func TestPromptsPageTableHeaders(t *testing.T) {
	ctx, cancel := newBrowser(t)
	defer cancel()
...
func TestPromptsPageFooterVisible(t *testing.T) {
	ctx, cancel := newBrowser(t)
	defer cancel()
...
func TestPromptsPageNoJSErrors(t *testing.T) {
	ctx, cancel := newBrowser(t)
	defer cancel()
...
func TestPromptsEditPageLayout(t *testing.T) {
	ctx, cancel := newBrowser(t)
	defer cancel()
...
func TestPromptsEditPageElements(t *testing.T) {
	ctx, cancel := newBrowser(t)
	defer cancel()
...
func TestPromptsEditPageNoJSErrors(t *testing.T) {
	ctx, cancel := newBrowser(t)
	defer cancel()
