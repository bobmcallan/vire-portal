...
func TestProfile(t *testing.T) {
	...
	t.Run("PageBodyPadding", func(t *testing.T) {
	...
	t.Run("PageBodyMaxWidth", func(t *testing.T) {
	...
	t.Run("NavexaSectionVisible", func(t *testing.T) {
	...
	t.Run("SectionHasBorder", func(t *testing.T) {
	...
	t.Run("SectionHasPadding", func(t *testing.T) {
	...
	t.Run("NavexaFormElements", func(t *testing.T) {
	...
	t.Run("NavVisible", func(t *testing.T) {
	...
	t.Run("FooterVisible", func(t *testing.T) {
	...
	t.Run("UserInfoSection", func(t *testing.T) {
