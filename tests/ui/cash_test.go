...
func TestCash(t *testing.T) {
	...
	t.Run("NavLinkActive", func(t *testing.T) {
	...
	t.Run("TransactionsTable", func(t *testing.T) {
	...
	t.Run("TransactionColors", func(t *testing.T) {
	...
	t.Run("NoRefreshButton", func(t *testing.T) {
...
// TestCashNavLinkFromDashboard navigates from /dashboard, so it needs its own browser session.
