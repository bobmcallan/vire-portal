...
func TestStrategy(t *testing.T) {
	...
	// Wait for Alpine to initialise and fetch data
	...
	t.Run("PlanEditor", func(t *testing.T) {
	...
	t.Run("InfoBanner", func(t *testing.T) {
	...
	t.Run("NoSaveButtons", func(t *testing.T) {
	...
	t.Run("NavActive", func(t *testing.T) {
	...
	t.Run("PlanNotesRow", func(t *testing.T) {
